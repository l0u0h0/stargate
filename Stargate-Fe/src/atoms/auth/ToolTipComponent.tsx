...
const ToolTipComponent = () => {
  ...
  return (
    <div className="relative m-2 z-10">
      ...
      <span className="inline-flex items-center rounded-md bg-slate-500 p-2 text-md font-medium text-white ring-1 ring-inset ring-slate-500/10">ToolTip Add</span>
      </div>
